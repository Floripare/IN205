	        ...
	        <div class="col s12">
	          ...
	          <table class="striped">
                ...
                <tbody id="results">
					...
					<%@ page import="java.util.List,com.ensta.librarymanager.service.MembreService,com.ensta.librarymanager.service.LivreService,com.ensta.librarymanager.service.EmpruntService,com.ensta.librarymanager.modele.Livre,com.ensta.librarymanager.modele.Emprunt,com.ensta.librarymanager.modele.Membre" %>
                	<c:forEach items="${empruntList}" var="emprunt">
                	<% Emprunt emprunt = (Emprunt) pageContext.getAttribute("emprunt"); %>
                	<% Livre livre = LivreService.getInstance().getById(emprunt.getIdLivre());%>
                	<% Membre membre = MembreService.getInstance().getById(emprunt.getIdMembre()); %>
                    <tr>
